...
from MainApp.serializers import DepartmentSerializer,EmployeeSerializer,EmployeeWriteSerializer
...
def departmentApi(request,id=0):
    ...
    return JsonResponse("You fucked up")
...
def employeeApi(request,id=0):
    if request.method=='GET':
        ...
        employees_serializer=EmployeeWriteSerializer(data=employee_data)
        ...
        employees_serializer=EmployeeWriteSerializer(employee,data=employee_data)
        if employees_serializer.is_valid():
                employees_serializer.save()
                return JsonResponse("Updated Successfully",safe=False)
